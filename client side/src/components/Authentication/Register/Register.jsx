...
const Register = () => {
    ...
    const handlefrom = (e) => {
        ...
        // console.log({name,email,image, password,conpass })
    }
    return (
        <div className="flex flex-col md:flex-row h-screen items-center">

            <div className="bg-indigo-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
                <img src={tec} alt="" className="w-full h-full object-cover" />
            </div>
    ...
    flex items-center justify-center">
                ...
                <div className="w-full h-100">
                    ...
                    <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12 capitalize text-center">Please Register</h1>
          ...
          px-4 py-3 mt-6">Register</button>
                    ...
                    <p className="mt-8 text-center"><span className='mr-2'>Already have an account?</span><Link to="/login" className="text-blue-500 hover:text-blue-700 font-semibold">Login</Link></p>
